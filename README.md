...
**⑧ 속보** — 화면 맨 위. 내가 찾기 전에 먼저 뜹니다.
> 🚨 **속보** — 거래정지, 파산, 인수합병, 가이던스 상·하향, SEC 조사, 경영진 사임, 급등락
> 🟠 **주목** — 실적 서프라이즈, 투자의견 변경, 구조조정, 증자, 계약·수주, 금리·물가
> 🟡 **참고** — 그 외

관심 종목 뉴스(Yahoo 티커 피드)와 시장 전체 뉴스(연준 보도자료, Google 뉴스)를 감시 주기마다 확인해 **텔레그램으로도 밀어줍니다.** 제목은 원문 그대로 두고, 왜 그 등급으로 봤는지 근거 표현을 함께 표시합니다. 관심 종목 관련 뉴스는 한 단계 더 중요하게 봅니다.

**⑨ 최근 공시 · 휴장일 · 경제지표 · 실적 일정**, 그리고 버튼(공시 확인 / 지표 새로고침 / **보고서 읽기** / 브리핑 보내기 / 종목 추가·삭제).
